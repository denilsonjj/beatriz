...
export default function App() {
          ...
          {isDateField && (
            <div className="mt-2 flex flex-wrap gap-2">
              <button
                ...
                className="rounded-xl bg-teal-50 border border-teal-200 px-4 py-2 text-sm font-bold text-teal-800 hover:bg-teal-100 transition shadow-sm"
              >
                📅 Usar data de Hoje
              </button>
              <button
        ...
        <div className="mt-2 flex flex-wrap gap-2">
          {chips.map((chip) => (
            <button
              ...
              className="rounded-xl bg-slate-100 border border-slate-300 px-3 py-2 text-sm font-bold text-slate-700 hover:bg-teal-50 hover:text-teal-900 hover:border-teal-300 transition shadow-sm active:scale-95"
            >
              {chip}
            </button>
          ))}
          ...
          <label className="block text-base font-bold text-slate-800" htmlFor="weight">
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              <button
                ...
                className="rounded-xl bg-slate-100 border border-slate-300 px-3 py-2 text-sm font-bold text-slate-700 hover:bg-teal-50 hover:text-teal-900 hover:border-teal-300 transition shadow-sm disabled:opacity-50"
  ...
  return (
    <main className={`min-h-screen bg-slate-50 px-4 py-6 sm:px-6 sm:py-10 transition-all duration-200 ${isLargeFont ? 'font-large' : ''}`}>
        ...
        <section aria-labelledby="dashboard-title">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
            ...
            <button
              ...
              className="rounded-xl border-2 border-teal-700 bg-white px-5 py-3 text-base font-extrabold text-teal-800 transition hover:bg-teal-50 disabled:cursor-not-allowed disabled:opacity-60 shadow-sm active:scale-95"
            >
          ...
          <div className="large-font-details mt-6 grid gap-4 lg:grid-cols-2">
            <article className="rounded-3xl bg-white p-5 shadow-soft border-2 border-slate-100">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="rounded-full bg-teal-100 px-3 py-1 text-sm font-extrabold text-teal-900 border border-teal-200">
                  {isDashboardLoading ? '...' : summary.pendingExams}
                </span>
              </div>
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-2">
            {formConfigs.map((form) => (
              <button
                ...
                className="min-h-[8.5rem] rounded-2xl border-2 border-slate-300 bg-white px-6 py-6 text-left shadow-soft transition hover:-translate-y-0.5 hover:border-teal-600 hover:bg-teal-50 focus:outline-none focus:ring-4 focus:ring-teal-200 active:scale-[0.98]"
              >
      ...
      {activeConfig && (
        <div
          className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/60 px-4 py-6 sm:py-10"
          role="presentation"
          // Removido o fechamento ao clicar fora para evitar perda de dados acidental (Dona Beatriz agradece!)
        >
          <section
            role="dialog"
            aria-modal="true"
            aria-labelledby="form-title"
            className="mx-auto w-full max-w-2xl rounded-3xl bg-white p-5 shadow-2xl sm:p-8 border-2 border-teal-100"
          >
            <div className="flex items-start justify-between gap-4 border-b border-slate-100 pb-4">
              <div>
                <h2 id="form-title" className="text-2xl font-extrabold text-teal-950">
                  {activeConfig.title}
                </h2>
                <p className="mt-2 text-base font-semibold leading-relaxed text-slate-600">{activeConfig.description}</p>
              </div>
              <button
                type="button"
                onClick={closeForm}
                ...
                className="rounded-2xl border-2 border-slate-300 bg-slate-50 px-4 py-2.5 text-base font-extrabold text-slate-700 hover:bg-slate-100 hover:border-slate-400 active:scale-95 transition"
              >
                Voltar
              </button>
            </div>
            ...
            <form className="mt-7 space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col-reverse gap-3 pt-4 border-t border-slate-100 sm:flex-row sm:justify-end">
                <button
                  ...
                  onClick={closeForm}
                  disabled={isSubmitting}
                  className="rounded-2xl border-2 border-slate-300 px-5 py-3.5 text-base font-extrabold text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60 active:scale-95"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="rounded-2xl bg-teal-700 px-6 py-3.5 text-base font-extrabold text-white transition hover:bg-teal-800 focus:outline-none focus:ring-4 focus:ring-teal-200 disabled:cursor-not-allowed disabled:opacity-60 active:scale-95 shadow-md"
                >
